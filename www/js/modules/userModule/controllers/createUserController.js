...
//        console.log(id);
    ...
    $scope.EndCreateUser = function () {
        ...
        var req = $http.get("http://192.168.0.101/index.php?user_login=" + $rootScope.userData.login + "&user_gender=" + $rootScope.userData.gender + "&deviceId=testid&avatar=" + $rootScope.userData.avatar + "&user_language=" + $rootScope.userData.lng + "&action=reg");
