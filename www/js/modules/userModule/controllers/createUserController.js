...
//        console.log(id);
    ...
    $scope.EndCreateUser = function () {
        ...
        var req = $http.get("http://krockappbackend/index.php?user_login=" + $rootScope.userData.login + "&user_gender=" + $rootScope.userData.gender + "&deviceId=testid&avatar=" + $rootScope.userData.avatar + "&user_language=" + $rootScope.userData.lng + "&action=reg");
